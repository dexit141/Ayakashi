...
public class GuiInGameHook extends GuiIngame {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (!mc.isSingleplayer() && !GameSettings.showDebugInfo && HudCommand.showHud()) {
            GL11.glPushMatrix();
            GL11.glEnable(3042);
            GL11.glEnable(3553);
            GL11.glEnable(2848);
    ...
    private void drawInfo() {
        ...
        GL11.glEnable(2848);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        mc.getTextureManager().bindTexture(new ResourceLocation("Ayakashi/menu/infobackground.png"));
        GL11.glBegin(7);
