    ...
    public void tryAcceptPlayer() {
        ...
        if (s != null) {
            ...
            if (this.server.getNetworkCompressionTreshold() >= 0 && !this.networkManager.isLocalChannel()) {
                this.networkManager.sendPacket(new S03PacketEnableCompression(this.server.getNetworkCompressionTreshold()), (p_operationComplete_1_) -> this.networkManager.setCompressionTreshold(this.server.getNetworkCompressionTreshold()));
            }
