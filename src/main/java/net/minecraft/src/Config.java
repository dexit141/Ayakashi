...
public class Config {
    ...
    public static String listToString(List<? extends String> p_listToString_0_) {
    ...
    public static boolean equalsOne(Enum p_equalsOne_0_, Object[] p_equalsOne_1_) {
    ...
    public static boolean isSameOne(net.minecraft.client.renderer.texture.TextureAtlasSprite p_isSameOne_0_, Object[] p_isSameOne_1_) {
