...
public class TextureMap extends AbstractTexture implements ITickableTextureObject {
    ...
    private int detectMinimumSpriteSize(Map<? extends String, ?> p_detectMinimumSpriteSize_1_, IResourceManager p_detectMinimumSpriteSize_2_) {
        Map<Integer, Integer> map = new HashMap<>();

        for (Entry<? extends String, ?> ff_Object : p_detectMinimumSpriteSize_1_.entrySet()) {
    ...
    private void updateIconGrid(int p_updateIconGrid_1_, int p_updateIconGrid_2_) {
        ...
        if (this.iconGridSize > 0) {
            ...
            iconGridCountY = p_updateIconGrid_2_ / this.iconGridSize;
            this.iconGrid = new TextureAtlasSprite[this.iconGridCountX * iconGridCountY];
            this.iconGridSizeU = 1.0D / (double) this.iconGridCountX;
            this.iconGridSizeV = 1.0D / (double) iconGridCountY;
