...
public class NetHandlerLoginClient implements INetHandlerLoginClient {
    ...
    public void handleEncryptionRequest(S01PacketEncryptionRequest packetIn) {
        ...
        this.networkManager.sendPacket(new C01PacketEncryptionResponse(secretkey, publickey, packetIn.getVerifyToken()), (p_operationComplete_1_) -> this.networkManager.enableEncryption(secretkey));
    }
