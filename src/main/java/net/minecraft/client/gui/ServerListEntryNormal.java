...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        ...
        if (this.server.pingToServer != -1L && this.server.pingToServer != -2L && !Minecraft.isGameMenu) {
            this.mc.fontRendererObj.drawString("§fVersion§8: §7" + this.server.gameVersion, x + 312, y + 2, 16777215);
            this.mc.fontRendererObj.drawString("§fPing§8: §7" + this.server.pingToServer + "ms", x + 312, y + 12, 16777215);
            this.mc.fontRendererObj.drawString("§fPlayers§8: §7" + this.server.populationInfo, x + 312, y + 22, 16777215);
        }
