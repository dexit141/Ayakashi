...
public class MapItemRenderer {
    ...
    class Instance {
        ...
        private void render(boolean noOverlayRendering) {
            ...
            worldrenderer.pos((float) (i + 0) + f, (float) (j + 128) - f, -0.01F).tex(0.0D, 1.0D).endVertex();
            worldrenderer.pos((float) (i + 128) - f, (float) (j + 128) - f, -0.01F).tex(1.0D, 1.0D).endVertex();
            worldrenderer.pos((float) (i + 128) - f, (float) (j + 0) + f, -0.01F).tex(1.0D, 0.0D).endVertex();
            worldrenderer.pos((float) (i + 0) + f, (float) (j + 0) + f, -0.01F).tex(0.0D, 0.0D).endVertex();
            tessellator.draw();
