...
import Ayakashi.helpers.ColorHelper;
    ...
    public void drawButton(Minecraft mc2, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            if (this.hovered) {
                ...
                color = -1877995504;
                textcol = ColorHelper.getRainbow(1L);
            }

            if (this.hovered) {
                Gui.drawRect(posx1, posy1 - 2, posx2, posy1, ColorHelper.getRainbow(1L));
                Gui.drawRect(posx1, posy2 + 2, posx2, posy2, ColorHelper.getRainbow(1L));
                Gui.drawRect(posx1, posy1 - 2, posx1 - 2, posy2 + 2, ColorHelper.getRainbow(1L));
                Gui.drawRect(posx2, posy1 - 2, posx2 + 2, posy2 + 2, ColorHelper.getRainbow(1L));
            }
