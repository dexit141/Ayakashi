...
public class GuiSlider extends GuiButton {
    ...
    public GuiSlider(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x2, int y2, String name, float min, float max, float defaultValue, GuiSlider.FormatHelper formatter) {
