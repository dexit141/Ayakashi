            ...
            if (i - this.systemTime >= 100L) {
                ...
                if (flag) {
                    ...
                    if (customloadingscreen != null) {
                        ...
                        worldrenderer.pos(0.0D, GuiScreen.height, 0.0D).tex(0.0D, 2.0D).color(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(GuiScreen.width, GuiScreen.height, 0.0D).tex(1.0D, 2.0D).color(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(GuiScreen.width, 0.0D, 0.0D).tex(1.0D, 1.0D).color(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, 1.0D).color(64, 64, 64, 255).endVertex();
                        tessellator.draw();
                    }
